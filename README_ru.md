...
| 🐦 | [X (Twitter)](docs/ru/XTwitterPlugin.md) | 1.00 | Хэштеги, твиты с текстом/миниатюрой/скриншотом.<br>Авто-добавление URL трансляции и хэштегов. Платный API X Developer Portal (Pay Per Use).<br>👉 [Подробнее](docs/ru/XTwitterPlugin.md) | [📥](https://raw.githubusercontent.com/miyumiyu/TeloPon-Extensions/main/plugins/XTwitterPlugin.py) |
