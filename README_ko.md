...
| 🐦 | [X (Twitter) 연동](docs/ko/XTwitterPlugin.md) | 1.00 | 해시태그 트윗을 가져와 AI에 주입.<br>AI가 방송 중 자동 트윗. X Developer Portal API 키 필요 (유료).<br>👉 [상세](docs/ko/XTwitterPlugin.md) | [📥](https://raw.githubusercontent.com/miyumiyu/TeloPon-Extensions/main/plugins/XTwitterPlugin.py) |
