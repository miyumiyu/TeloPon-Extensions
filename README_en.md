...
| 🐦 | [X (Twitter)](docs/en/XTwitterPlugin.md) | 1.00 | Hashtag fetch, tweet with text/thumbnail/screen capture.<br>Auto-appends stream URL and hashtags. Requires X Developer Portal paid API (Pay Per Use).<br>👉 [Details](docs/en/XTwitterPlugin.md) | [📥](https://raw.githubusercontent.com/miyumiyu/TeloPon-Extensions/main/plugins/XTwitterPlugin.py) |
