...
| 🎮 | [VCI OSC テロップ](docs/ja/VciOscPlugin.md) | 1.00 | [VirtualCast](https://virtualcast.jp/) の VCI に OSC でテロップを送信。<br>VR空間内にAIのテロップを表示できます。<br>👉 [詳細はこちら](docs/ja/VciOscPlugin.md) | [📥](https://raw.githubusercontent.com/miyumiyu/TeloPon-Extensions/main/plugins/VciOscPlugin.py) |
