...
| | プラグイン | Ver | 説明 | DL |
|---|---|---|---|---|
| 📺 | [YouTube Live+](docs/ja/YoutubeLiveOAuth.md) | 1.03 | YouTube OAuth連携。コメント読み書き・アンケート・タイトル変更・視聴者数取得。<br>👉 [詳細はこちら](docs/ja/YoutubeLiveOAuth.md) / [GCP設定ガイド](docs/ja/YoutubeLiveOAuth_GCP_Setup.md) | [📥](https://raw.githubusercontent.com/miyumiyu/TeloPon-Extensions/main/plugins/YoutubeLiveOAuth.py) |
...
| 🔊 | [テロップ読み上げ (Gemini TTS)](docs/ja/GeminiTTS.md) | 1.00 | 最新の Gemini 3.1 Flash TTS でテロップを高品質読み上げ。30種のボイス・感情・キャラ指示対応。<br>👉 [詳細はこちら](docs/ja/GeminiTTS.md) | [📥](https://raw.githubusercontent.com/miyumiyu/TeloPon-Extensions/main/plugins/GeminiTTS.py) |
