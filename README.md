...
| 🐦 | [X (Twitter)](docs/ja/XTwitterPlugin.md) | 1.00 | ハッシュタグ取得・テキスト/サムネイル/画面キャプチャ付きツイート投稿。<br>配信URL・ハッシュタグ自動付与。X Developer Portal の有料API（Pay Per Use）が必要。<br>👉 [詳細はこちら](docs/ja/XTwitterPlugin.md) | [📥](https://raw.githubusercontent.com/miyumiyu/TeloPon-Extensions/main/plugins/XTwitterPlugin.py) |
